...
public class MiningFacilityGeneration : GenerationStep
{
    ...
    /// </summary>
    public readonly string MiningFacilityWallFloorComponentTag;
    ...
    public MiningFacilityGeneration(
        ...
        string name = null,
        string miningFacilityWallFloorComponentTag = "MiningFacilityWallFloor",
        ...
        : base(name)
    {
        ...
        _renderer = renderer;
        MiningFacilityWallFloorComponentTag = miningFacilityWallFloorComponentTag;
    ...
    protected override IEnumerator<object> OnPerform(GenerationContext generationContext)
    {
        ...
        var miningFacilityWallFloor = data.Select(c => c.Equals(Color.Black) ? false : true).ToArray();

        generationContext.GetFirstOrNew<ISettableGridView<bool>>(
            () => new ArrayView<bool>(miningFacilityWallFloor, generationContext.Width),
            WallFloorComponentTag
        );

        var stockpileWallFloor = data.Select(c => c.Equals(Color.Red) ? false : true).ToArray();
