...
public class WallDoorGeneration : GenerationStep
{
    private readonly Func<GameObjectType, bool> _resolver;
    ...
    public WallDoorGeneration(Func<GameObjectType, bool> resolver, FloorType floorType, DoorType doorType, string name = null, int minDoors = 1, int maxDoors = 1)
        : base(name)
    {
        _resolver = resolver;
    ...
    {
        var areas = context
            .GetFirst<ArrayView<>>(AreasComponentTag)
