...
{
    public class LoadReplayView : BaseMarsUndiscoveredView<LoadReplayViewModel, LoadReplayData>
    {
        ...
        public LoadReplayView(LoadReplayViewModel loadReplayViewModel, ISaveGameService saveGameService)
        : base(loadReplayViewModel)
        {
        ...
        protected override void InitializeInternal()
        {
            ...
            new Label("Choose a recording to load:")
                .Centred()
        ...
        private void OnValueChange(Entity entity)
        {
            if (_fileNameList.SelectedIndex != -1)
            {
                ...
                Mediator.Send(new LoadReplayRequest { Filename = _loadGameDetails[_fileNameList.SelectedIndex].Filename });
            }
        }
